...
# Ejemplo
entrada = [ [0.7, 1.3], [2.0, 1.1], [1.3, 2.09],
            [2.25, 1.0], [1.5, 2.1]]
salida = [0,0,0,1,1]
...
#que pasa si agrego un punto extra y no "recalculo" la recta con azar (evito lineas 24-26)
entrada = [ [0.7, 1.3], [2.0, 1.1], [1.3, 2.09],[1.42, 2.09],
            [2.25, 1.0], [1.5, 2.1]]
salida = [0,0,0,0,1,1]
